...
CREATE TABLE `demande` (
  ...
  `topo` varchar(30) DEFAULT NULL,
  `reponse` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `demande` VALUES (1,'test','Clement','Mon topo','oui'),(2,'Clement','test','nieme topo','oui'),(3,'Clement','test','Topo 3','aucune');
