...
CREATE TABLE `voie` (
  ...
  `cotation` varchar(200) DEFAULT NULL,
  `longueur` decimal(10,0) DEFAULT NULL,
  `secteur` varchar(200) DEFAULT NULL,
  `secteur_id` smallint(5) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_secteur_id` (`secteur_id`),
...
INSERT INTO `voie` VALUES (1,'1ere voie','5b',100,'Secteur birsois',2),(2,'Best voie','4c',124,'Secteur birsois',2),(3,'Tout droit','8b',213,'Cool',4),(5,'Voie oklm','9c',1019,'Alley',6),(6,'Grimpeur','8a',382,'Great',1);
